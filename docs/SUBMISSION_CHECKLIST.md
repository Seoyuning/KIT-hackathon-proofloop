...
- 배포된 라이브 URL
  `https://proofloop-kit-vibehackathon.vercel.app`
...
- 라이브 URL이 열리는지 확인
- 메인 화면에서 `Fast finisher` 프리셋과 `Instructor Radar`가 정상 동작하는지 확인
...
1. 문제 정의
2. Diagnosis Studio 시연
3. Instructor Radar 시연
4. 왜 LMS가 아닌지, 왜 지금 필요한지 한 줄 정리
